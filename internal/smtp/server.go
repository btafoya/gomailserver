...
func NewServer(cfg *config.SMTPConfig, tlsCfg *tls.Config, userSvc *service.UserService, messageSvc *service.MessageService, queueSvc *service.QueueService, logger *zap.Logger) *Server {
	backend := &Backend{
		userService:    userSvc,
