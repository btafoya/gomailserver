import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, computed, ref, watch, nextTick, unref, Suspense, mergeProps, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/h3@1.15.4/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, defuFn, createDefu } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/ufo@1.6.2/node_modules/ufo/dist/index.mjs";
import { klona } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/home/btafoya/projects/gomailserver/unified/node_modules/.pnpm/@unhead+vue@2.1.1_vue@3.5.26/node_modules/@unhead/vue/dist/index.mjs";
...
const unhead_ZPj3kp79W0Tkt3OY3tqr9telkzYAWiW44ZW3MeLFEnc = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-CxvziQQM.js")
  },
  {
    name: "portal",
    path: "/portal",
    component: () => import("./_nuxt/index-Do9XY-lS.js")
  },
  {
    name: "webmail",
    path: "/webmail",
    component: () => import("./_nuxt/index-1GVt-p-m.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-k3UVQA9E.js")
};
...
const revive_payload_server_u7h9kqHRLUvT6W2UXsqzr93HJgIPL5RSJ9suaI7epAY = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-DZ3dZRg_.js").then((r) => r["default"] || r.default || r));
...
const slideovers_8PjAKljq0FzQVpDuxR3FkM4Woxnfxtds38TYikcaDrQ = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const modals_vmZq5xrAiMnPGHBs58zSIvQqBva3C7m0RmCCGq3QDR0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const colors_r6Q6mZexSeFCGRvpcpQATFhC8QQoSNqFz7xjjuGLdvI = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_P4zXSwqw_d470LL6MrEpRI3PI9g_trMjoHkDHU0bNdA = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const plugins = [
  payloadPlugin,
  unhead_ZPj3kp79W0Tkt3OY3tqr9telkzYAWiW44ZW3MeLFEnc,
  plugin$1,
  revive_payload_server_u7h9kqHRLUvT6W2UXsqzr93HJgIPL5RSJ9suaI7epAY,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  slideovers_8PjAKljq0FzQVpDuxR3FkM4Woxnfxtds38TYikcaDrQ,
  modals_vmZq5xrAiMnPGHBs58zSIvQqBva3C7m0RmCCGq3QDR0,
  colors_r6Q6mZexSeFCGRvpcpQATFhC8QQoSNqFz7xjjuGLdvI,
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.26_cac@6.7.14_db0@0.3.4_ioredis_08cdc1528ee70955f497bd6c87fc8bee/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BADfeJyn.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.26_cac@6.7.14_db0@0.3.4_ioredis_08cdc1528ee70955f497bd6c87fc8bee/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.20.2_@parcel+watcher@2.5.1_@vue+compiler-sfc@3.5.26_cac@6.7.14_db0@0.3.4_ioredis_08cdc1528ee70955f497bd6c87fc8bee/node_modules/nuxt/dist/app/components/nuxt-root.vue");
